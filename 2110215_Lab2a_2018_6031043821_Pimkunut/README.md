...
3. Rename the project to **`2110215_Lab2a_2018_{ID}_{FIRSTNAME}`** (Example: **`2110215_Lab2a_2018_6031234521_Alice`**).
...
7. Export your project into a runnable jar file called **`Lab2a_2018_{ID}`** (Example: **`Lab2a_2018_6031234521.jar`**) and place it at the root of your project.
